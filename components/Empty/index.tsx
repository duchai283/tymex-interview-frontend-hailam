  ...
  return (
    <div className="w-full flex items-center flex-wrap justify-center gap-10">
      <div className="grid gap-4 w-60">
        ...
        <div>
          <h2 className="text-center text-white text-xl font-semibold leading-loose pb-2">
            There’s no data here
          </h2>
          <p className="text-center text-white text-base font-normal leading-relaxed pb-4">
